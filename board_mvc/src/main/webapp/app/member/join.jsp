					...
					<form method="post" action="${pageContext.request.contextPath}/member/MemberJoinOk.me" name="joinForm">
						<div style="display:flex; justify-content:space-around;">
							...
							<div class="preview" style="width:40%">
								<div>
									<h4>오늘 하루는 어떠셨나요 ?</h4>
									<img src="${pageContext.request.contextPath}/images/white1.jpg">
								</div>
								<hr>
								<div>
									<h4>오늘 겪은 안좋은 기분들을 버려주세요!</h4>
									<img src="${pageContext.request.contextPath}/images/white3.jpg">
								</div>
								<hr>
								<div>
									<h4>감정 쓰레기통입니다!</h4>
									<img src="${pageContext.request.contextPath}/images/white2.jpg">
								</div>
							</div>
						</div>
					</form>
